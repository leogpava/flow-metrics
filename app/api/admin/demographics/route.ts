...
import { getAdminDemographics } from '@/features/admin/services/dashboard';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await getAdminDemographics(startDate, endDate);
    ...
    const message = error instanceof Error ? error.message : 'Erro ao carregar a análise demográfica.';
