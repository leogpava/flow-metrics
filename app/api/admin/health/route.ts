...
import { getAdminHealth } from '@/features/admin/services/dashboard';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await getAdminHealth(startDate, endDate);
    ...
    const message = error instanceof Error ? error.message : 'Erro ao carregar a análise de saúde.';
